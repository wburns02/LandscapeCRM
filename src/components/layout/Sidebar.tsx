...
import {
  ...
  Sparkles, CloudSun, HardHat, Rocket, MessageSquare, Trees, Moon, Shield, Radio, BellRing, Star, CalendarPlus, Plug, BookOpen, ShoppingCart,
  type LucideIcon,
} from 'lucide-react';
...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/properties', icon: Trees, label: 'Properties' },
